...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    // client-side password match check before hitting the backend
  ...
  return (
    <section className="relative flex flex-col justify-center items-center min-h-screen w-full text-white px-4 py-12">
      ...
      >
        ...
        <motion.div variants={fadeUp} className="flex flex-col items-center gap-2 text-center">
          ...
          <p className="text-sm text-gray-400">
            If you are a core team member, ask admin to grant you 'MEMBER' access.
          </p>
        </motion.div>
